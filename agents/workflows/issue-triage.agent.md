...
description: "Orchestration layer for automated issue triage — activation guard, procedure, output behavior, and constraints"
---
...
Follow the detailed per-step procedure defined in
...
Follow the triage workflow defined in the Issue Triage Agent instructions:
