...
### Check if the RN follows the latest guidelines:

You MUST add following sentence at the end of the RN: "This release note was generated by an agent following the latest guidelines as of 21/05/2026." This signals to reviewers that the RN adheres to the most current standards and practices.